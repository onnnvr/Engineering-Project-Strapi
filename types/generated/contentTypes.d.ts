...
export interface ApiCustomerCustomer extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    number: Schema.Attribute.String & Schema.Attribute.Unique;
    orders: Schema.Attribute.Relation<'oneToMany', 'api::order.order'>;
    payments: Schema.Attribute.Relation<'oneToMany', 'api::payment.payment'>;
    publishedAt: Schema.Attribute.DateTime;
    totalDebt: Schema.Attribute.Decimal;
    type: Schema.Attribute.Enumeration<['company', 'person', 'trader']> &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    addTaxes: Schema.Attribute.Boolean & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    > &
      Schema.Attribute.DefaultTo<'Delivered'>;
    ...
    returns: Schema.Attribute.Relation<'oneToMany', 'api::return.return'>;
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    inventories: Schema.Attribute.Relation<
      ...
      'api::inventory.inventory'
    >;
    isTemporary: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
    ...
    productStatus: Schema.Attribute.Enumeration<['published', 'draft']> &
      Schema.Attribute.Required &
    ...
    >;
    returned_items: Schema.Attribute.Relation<
      'oneToMany',
      'api::returned-item.returned-item'
    >;
...
export interface ApiPurchasePaymentPurchasePayment
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::purchase-payment.purchase-payment'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    purchase: Schema.Attribute.Relation<'manyToOne', 'api::purchase.purchase'>;
    trader: Schema.Attribute.Relation<'manyToOne', 'api::trader.trader'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiPurchasePurchase extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    purchase_items: Schema.Attribute.Relation<
      ...
      'api::purchase-item.purchase-item'
    >;
    purchase_payments: Schema.Attribute.Relation<
      'oneToMany',
      'api::purchase-payment.purchase-payment'
    >;
...
export interface ApiReturnedItemReturnedItem
  extends Struct.CollectionTypeSchema {
  collectionName: 'returned_items';
  info: {
    displayName: 'Returned-item';
    pluralName: 'returned-items';
    singularName: 'returned-item';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    quantity: Schema.Attribute.Decimal & Schema.Attribute.Required;
    return: Schema.Attribute.Relation<'manyToOne', 'api::return.return'>;
    totalAmount: Schema.Attribute.Decimal;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiTraderTrader extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    totalDebt: Schema.Attribute.Decimal & Schema.Attribute.DefaultTo<0>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    google_token: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'plugin::users-permissions.user'
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::purchase-payment.purchase-payment': ApiPurchasePaymentPurchasePayment;
      'api::purchase.purchase': ApiPurchasePurchase;
      'api::return.return': ApiReturnReturn;
      'api::returned-item.returned-item': ApiReturnedItemReturnedItem;
